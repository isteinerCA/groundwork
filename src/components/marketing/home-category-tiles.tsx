...
function isGradeBand(value: string | null): value is "high-school" | "middle-school" {
  return value === "high-school" || value === "middle-school";
}

function loadGradeBand(): "high-school" | "middle-school" | null {
  try {
...
function saveGradeBand(gradeBand: "high-school" | "middle-school"): void {
  try {
...
const GRADE_BANDS: { id: Exclude<GradeBand, "all-grades">; label: string }[] = [
  { id: "high-school", label: "High school" },
  { id: "middle-school", label: "Middle school" },
];

export function HomeCategoryTiles({ tiles }: { tiles: HomeCategoryTile[] }) {
  const [gradeBand, setGradeBand] = useState<"high-school" | "middle-school">("high-school");
  ...
  function selectGradeBand(next: "high-school" | "middle-school") {
    setGradeBand(next);
    saveGradeBand(next);
  }
