...
export const DOMESTIC_INTEREST_LIST_DEFS: DomesticInterestListDef[] = [
  ...
  {
    slug: "new-england-us-programs",
    linkLabel: "New England",
    dataQuery: "",
    group: "where",
    titleLabel: "New England programs",
    includeLocations: [
      "maine",
      "new hampshire",
      "vermont",
  ...
  {
    slug: "pacific-northwest-us-programs",
    linkLabel: "Pacific Northwest",
    dataQuery: "",
    group: "where",
    titleLabel: "Pacific Northwest programs",
    includeLocations: [
      "pacific northwest",
      "olympic",
      "seattle",
  ...
  {
    slug: "washington-dc-us-programs",
    linkLabel: "Washington, D.C.",
    dataQuery: "",
    group: "where",
    titleLabel: "Washington, D.C. programs",
    includeLocations: [
