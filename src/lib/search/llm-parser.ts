...
${categories}
  When ADDING or EXPANDING categories ("expand to marine science", "add tech camps", "also include STEM"), return the full combined list (current + new). Map informal names: "tech"/"tech camps"/"coding"/"AI" → artificial-intelligence; "STEM"/"science" → stem-engineering; "diplomacy"/"international relations" → international-relations.
